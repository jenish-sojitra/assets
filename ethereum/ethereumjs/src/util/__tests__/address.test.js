...
describe('Address', () => {
  ...
  tape('should validate address length', (st) => {
  ...
  tape('should generate a zero address', (st) => {
  ...
  tape('should instantiate address from zero address string', (st) => {
  ...
  tape('should detect non-zero address', (st) => {
  ...
  tape('should instantiate from public key', (st) => {
  ...
  tape('should fail to instantiate from invalid public key', (st) => {
    const pubKey = Buffer.from(
  ...
  tape('should instantiate from private key', (st) => {
    // prettier-ignore
  ...
  tape('should generate address for created contract', (st) => {
  ...
  tape('should provide correct precompile check', (st) => {
  ...
  tape('should generate address for CREATE2', (st) => {
  ...
  tape('should provide a buffer that does not mutate the original address', (st) => {
    const str = '0x2f015c60e0be116b1f0cd534704db9c92118fb6a'
  ...
  tape('should compare equality properly', (st) => {
    const str = '0x2f015c60e0be116b1f0cd534704db9c92118fb6a'
