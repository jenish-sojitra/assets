...
import { unpadBuffer } from '../../util/extra.js'
import { bufferToHex, intToBuffer, toBuffer } from '../../util/index.js'
import { Transaction } from '../index.js'
import loadFixture from './load-fixture.cjs'

const txFixtures = loadFixture('txs')
const txFixturesEip155 = loadFixture('ttTransactionTestEip155VitaliksTests')
...
describe('[Transaction]', function () {
  ...
  t.test('getBaseFee() -> should return base fee', function (st) {
    ...
    st.equals(tx.getBaseFee().toNumber(), 53_000)
    st.end()
  })
  ...
  t.test('getUpfrontCost() -> should return upfront cost', function (st) {
    ...
    st.equals(tx.getUpfrontCost().toNumber(), 10_000_000_042)
    st.end()
  })
  ...
  t.test('isSigned() -> returns correct values', function (st) {
    ...
    const signedValues = rlp.decode(rawSigned)
