// from @metamask/eth-sig-util@4.0.1, with some lint + removed unused stuff
// We also do a fix 'bBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB' -> '12222222222222222222222222222222222222221',
// both in this file and in snapshot names, see explanation below
...
const encodeDataExamples = {
  ...
  string: ['Hello!', '0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB', '0xabcd', '😁', 10],
  ...
  address: [
    ...
    // There was an error here, unprefixed number was used and incorrectly parsed by bn.js@4 as a decimal
  ...
  bytes1: ['0x10', 10, 0, 1, -1, Number.MAX_SAFE_INTEGER, Buffer.from('10', 'utf8')],
  bytes32: ['0x10', 10, 0, 1, -1, Number.MAX_SAFE_INTEGER, Buffer.from('10', 'utf8')],
...
const allExampleTypes = [
  ...new Set([...Object.keys(encodeDataExamples), ...Object.keys(encodeDataErrorExamples)]),
]
...
describe('TypedDataUtils.encodeData', function () {
  ...
  describe('V3', function () {
    ...
    it('should encode data with custom type', function () {
      ...
      expect(
        TypedDataUtils.encodeData(primaryType, message, types, SignTypedDataVersion.V3).toString(
          'hex'
        )
      ).toMatchSnapshot()
    })
    ...
    it('should throw an error when trying to encode a custom type array', function () {
      ...
      expect(() =>
        TypedDataUtils.encodeData('Message', message, types, SignTypedDataVersion.V3).toString(
          'hex'
        )
      ).toThrow('Arrays are unimplemented in encodeData; use V4 extension')
    })
    ...
    it('should encode data when called unbound', function () {
      ...
      expect(
        hashStruct(primaryType, message, types, SignTypedDataVersion.V3).toString('hex')
      ).toMatchSnapshot()
    })
  })
  ...
  describe('V4', function () {
    ...
    it('should encode data with custom type', function () {
      ...
      expect(
        TypedDataUtils.encodeData(primaryType, message, types, SignTypedDataVersion.V4).toString(
          'hex'
        )
      ).toMatchSnapshot()
    })
    ...
    it('should throw an error when trying to encode a function', function () {
      ...
      expect(() =>
        TypedDataUtils.encodeData('Message', message, types, SignTypedDataVersion.V4).toString(
          'hex'
        )
      ).toThrow('Unsupported or invalid type: function')
    })
    ...
    it('should encode data when called unbound', function () {
      ...
      expect(
        encodeData(primaryType, message, types, SignTypedDataVersion.V4).toString('hex')
      ).toMatchSnapshot()
    })
  })
  ...
  it('should throw if passed an invalid version', () => {
    ...
    const message = { data: 'Hello!' }
    expect(() =>
      TypedDataUtils.encodeData('Message', message, types, 'V0').toString('hex')
  ...
  it('should throw if passed a version that is not allowed', () => {
    ...
    const message = { data: 'Hello!' }
    expect(() =>
      TypedDataUtils.encodeData('Message', message, types, SignTypedDataVersion.V1).toString('hex')
...
describe('TypedDataUtils.hashStruct', function () {
  ...
  describe('V3', function () {
    ...
    it('should hash data with custom type', function () {
      ...
      expect(
        TypedDataUtils.hashStruct(primaryType, message, types, SignTypedDataVersion.V3).toString(
          'hex'
        )
      ).toMatchSnapshot()
    })
    ...
    it('should throw an error when trying to hash a custom type array', function () {
      ...
      expect(() =>
        TypedDataUtils.hashStruct('Message', message, types, SignTypedDataVersion.V3).toString(
          'hex'
        )
      ).toThrow('Arrays are unimplemented in encodeData; use V4 extension')
    })
  ...
  describe('V4', function () {
    ...
    it('should hash data with custom type', function () {
      ...
      expect(
        TypedDataUtils.hashStruct(primaryType, message, types, SignTypedDataVersion.V4).toString(
          'hex'
        )
      ).toMatchSnapshot()
    })
    ...
    it('should throw an error when trying to hash a function', function () {
      ...
      expect(() =>
        TypedDataUtils.hashStruct('Message', message, types, SignTypedDataVersion.V4).toString(
          'hex'
        )
      ).toThrow('Unsupported or invalid type: function')
    })
    ...
    it('should hash data when called unbound', function () {
      ...
      expect(
        hashStruct(primaryType, message, types, SignTypedDataVersion.V4).toString('hex')
      ).toMatchSnapshot()
    })
  })
  ...
  it('should throw if passed an invalid version', () => {
    ...
    const message = { data: 'Hello!' }
    expect(() =>
      TypedDataUtils.hashStruct('Message', message, types, 'V0').toString('hex')
    ).toThrow('Invalid version')
  })
  ...
  it('should throw if passed a version that is not allowed', () => {
    ...
    const message = { data: 'Hello!' }
    expect(() =>
      TypedDataUtils.hashStruct('Message', message, types, SignTypedDataVersion.V1).toString('hex')
    ).toThrow('SignTypedDataVersion not allowed')
  })
})
...
describe('TypedDataUtils.hashType', () => {
  ...
  it('should hash simple type', () => {
    ...
    expect(TypedDataUtils.hashType(primaryType, types).toString('hex')).toMatchInlineSnapshot(
  ...
  it('should throw if primary type is missing', () => {
    ...
    expect(() => TypedDataUtils.hashType(primaryType, types).toString('hex')).toThrow(
      'No type definition specified: Mail'
    )
  })
...
describe('TypedDataUtils.findTypeDependencies', () => {
  it('should return type dependencies of a simple type', function () {
    ...
    expect(TypedDataUtils.findTypeDependencies(primaryType, types)).toStrictEqual(
      new Set(['Person'])
    )
  })
  ...
  it('should return empty set if primary type is missing', function () {
    ...
    expect(TypedDataUtils.findTypeDependencies(primaryType, {})).toStrictEqual(new Set())
  })
...
const signTypedDataV1Examples = {
  // dynamic types supported by EIP-712:
  bytes: [10, '10', '0x10', Buffer.from('10', 'utf8')],
  string: ['Hello!', '0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB', '0xabcd', '😁'],
  // atomic types supported by EIP-712:
  address: [
    '0xbBbBBBBbbBBBbbbBbbBbbbbBBbBbbbbBbBbbBBbB',
...
describe('typedSignatureHash', function () {
  ...
  for (const { input, errorMessage, label } of invalidTypedMessages) {
    it(`should throw when given ${label}`, function () {
      expect(() => typedSignatureHash(input)).toThrow(errorMessage)
    })
  }
