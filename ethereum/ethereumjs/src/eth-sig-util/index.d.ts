 ...
 */
export declare function personalSign({
  privateKey,
  data,
}: {
  privateKey: Buffer
 ...
 */
declare function findTypeDependencies(
  primaryType: string,
  types: Record<string, MessageTypeProperty[]>,
  results?: Set<string>
): Set<string>
 ...
 */
declare function eip712Hash<T extends MessageTypes>(
 ...
 * @returns The '0x'-prefixed hex encoded signature.
 */
export declare function signTypedData<V extends SignTypedDataVersion, T extends MessageTypes>({
  privateKey,
  data,
  version,
}: {
