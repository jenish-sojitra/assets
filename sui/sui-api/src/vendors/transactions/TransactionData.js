...
const { toBase58, normalizeSuiAddress } = vendorLib.utils
...
class TransactionDataBuilder {
  ...
  build({ maxSizeBytes = Infinity, overrides, onlyTransactionKind } = Object.create(null)) {
  ...
  mapCommandArguments(index, fn) {
    ...
    switch (command.$kind) {
      ...
      case '$Intent':
        ...
        command.$Intent.inputs = Object.create(null)
